<?php
	trait CartModel{		
		...
		public function cartCheckOut(){
			...
			foreach($_SESSION["cart"] as $product){
				$query = $conn->prepare("insert into orderdetails set order_id=:order_id, product_id=:product_id, price=:price, quantity=:quantity,address='$address'");
		...
		// 	$conn = Connection::getInstance();
		// 	$address = $_POST["address"];
		// 	$queryCart = $conn->query("select order_id from ordersdetail where order_id=$id");
		// 	$checkCart = $queryCart->rowCount();
		// 	if($id = $checkCart)
		// 	$query = $conn->query("insert into orders set address='$address'");
		// }
		//=============
	}	
?>